...
<Project Type="Project" LVVersion="9008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="sendTCPString.vi" Type="VI" URL="../../shared programs/TCP/sendTCPString.vi"/>
		<Item Name="ManualDeviceControl.vi" Type="VI" URL="../../Device Driver/DeviceTemplate/ManualDeviceControl.vi"/>
		<Item Name="status in device case.vi" Type="VI" URL="../status in device case.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="DataQueueTypeDef.ctl" Type="VI" URL="../DataQueueTypeDef.ctl"/>
			<Item Name="manualInput.vi" Type="VI" URL="../../shared programs/manualInput.vi"/>
			...
			<Item Name="indicator for manual commands.vi" Type="VI" URL="../indicator for manual commands.vi"/>
			<Item Name="cleanArrayRing.vi" Type="VI" URL="../cleanArrayRing.vi"/>
			<Item Name="Allowed Variables from string.vi" Type="VI" URL="../Allowed Variables from string.vi"/>
			...
			<Item Name="getTCPSendPath.vi" Type="VI" URL="../getTCPSendPath.vi"/>
			<Item Name="getRootPath.vi" Type="VI" URL="../../shared programs/getRootPath.vi"/>
			...
			<Item Name="ImageAlreadyProcessed.vi" Type="VI" URL="../ImageAlreadyProcessed.vi"/>
			<Item Name="losslessCompression.vi" Type="VI" URL="../losslessCompression.vi"/>
			...
			<Item Name="updateSelection.vi" Type="VI" URL="../../shared programs/updateSelection.vi"/>
			<Item Name="delete dublica (string array).vi" Type="VI" URL="../../shared programs/delete dublica (string array).vi"/>
			<Item Name="getSubVromQueue.vi" Type="VI" URL="../../Device Driver/Analysis/getSubVromQueue.vi"/>
			<Item Name="CallDeviceSubViDynamic.vi" Type="VI" URL="../CallDeviceSubViDynamic.vi"/>
			<Item Name="Device cluster to publisher cluster.vi" Type="VI" URL="../Device cluster to publisher cluster.vi"/>
			...
			<Item Name="Publisher Cluster to device cluster.vi" Type="VI" URL="../Publisher Cluster to device cluster.vi"/>
			...
			<Item Name="CallDeviceSubVi.vi" Type="VI" URL="../CallDeviceSubVi.vi"/>
			<Item Name="updateVarto Cluster.vi" Type="VI" URL="../updateVarto Cluster.vi"/>
		</Item>
